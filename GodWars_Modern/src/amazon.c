...
/* Compatibility defines for Midnight-Realities constants not in target */
#ifndef VAM_MORTAL
#define VAM_MORTAL  0   /* mortal-vampire flag — not used in this codebase */
#endif

/* Forward declaration for social command check (defined in interp.c) */
...
void do_amazcamouflage( CHAR_DATA *ch, char *argument)
{
...
void do_amazspinkick( CHAR_DATA *ch, char *argument )
{
	char arg1[MAX_INPUT_LENGTH];	
	int dam;
	CHAR_DATA *victim;
...
void do_amazknee( CHAR_DATA *ch, char *argument )
{
	char arg1[MAX_INPUT_LENGTH];	
	int dam;
	CHAR_DATA *victim;
...
void do_amazbackfist( CHAR_DATA *ch, char *argument )
{
	char arg1[MAX_INPUT_LENGTH];	
	int dam;
	CHAR_DATA *victim;
