...
char *item_type_name( int item_type )
{
    ...
    case ITEM_PTOKEN:		return "primal token";
    ...
    case ITEM_SIT_SINGLE:	return "chair";
    case ITEM_SIT_DOUBLE:	return "love seat";
    case ITEM_SIT_TRIPLE:	return "couch";
    }
...
int item_name_type( char *name )
{
    ...
    if ( !str_cmp( name, "notepaper" ) ) return ITEM_NOTEPAPER;
    ...
    if ( !str_cmp( name, "chair"     ) ) return ITEM_SIT_SINGLE;
    if ( !str_cmp( name, "love seat" ) ) return ITEM_SIT_DOUBLE;
    if ( !str_cmp( name, "couch"     ) ) return ITEM_SIT_TRIPLE;
