...
//    { "airmail",	do_airmail,	POS_DEAD,	 7,  LOG_NORMAL },
    { "class",          do_autoclass,   POS_STANDING,    0,  LOG_ALWAYS },
    ...
    { "orb",            do_orb,         POS_STANDING,    0,  LOG_NORMAL },
    ...
    { "stun", 		do_stun, 	POS_DEAD, 	 0,  LOG_NORMAL },
...
/*
    { "improve",	do_improve,	POS_SITTING,	 2,  LOG_ALWAYS },
*/
    { "windwhisper", 	do_windwhisper, POS_DEAD,	 0,  LOG_NORMAL },
    { "ktalk",          do_ktalk,       POS_DEAD,        0,  LOG_NORMAL },
    { "mikt",	 	do_miktalk,	POS_DEAD,	 0,  LOG_NORMAL },
    { "monk",		do_monktalk,	POS_DEAD,	 0,  LOG_NORMAL },
    ...
    { "flametalk",      do_flametalk,   POS_DEAD,        0,  LOG_NORMAL },
...
*/
    ...
    { "leaderboard",    do_leader,      POS_SLEEPING,    0,  LOG_NORMAL },
    { "practice",	do_practice,	POS_SLEEPING,	 0,  LOG_NORMAL	},

    /* Bard class commands */
    { "play",           do_play,        POS_STANDING,    0,  LOG_NORMAL },

    /* Amazon class commands */
    { "succour",        do_succour,     POS_FIGHTING,    0,  LOG_NORMAL },
    { "drill",          do_drill,       POS_STANDING,    0,  LOG_NORMAL },
    { "sisters",        do_sisters,     POS_STANDING,    0,  LOG_NORMAL },
    { "cognizance",     do_cognizance,  POS_STANDING,    0,  LOG_NORMAL },
    { "amazcamouflage", do_amazcamouflage,POS_STANDING,   0,  LOG_NORMAL },
    { "seduce",         do_seduce,      POS_STANDING,    0,  LOG_NORMAL },
    { "net",            do_net,         POS_FIGHTING,    0,  LOG_NORMAL },
    { "barkskin",       do_barkskin,    POS_STANDING,    0,  LOG_NORMAL },
    { "agenesis",       do_genesis,     POS_STANDING,    0,  LOG_NORMAL },
    { "flare",          do_flare,       POS_FIGHTING,    0,  LOG_NORMAL },
    { "steelfist",      do_steelfist,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "combo",          do_combo,       POS_FIGHTING,    0,  LOG_NORMAL },
    { "praise",         do_praise,      POS_STANDING,    0,  LOG_NORMAL },
    { "amazspinkick",   do_amazspinkick,POS_FIGHTING,    0,  LOG_NORMAL },
    { "sweepkick",      do_sweepkick,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "axekick",        do_axekick,     POS_FIGHTING,    0,  LOG_NORMAL },
    { "forearm",        do_forearm,     POS_FIGHTING,    0,  LOG_NORMAL },
    { "amazknee",       do_amazknee,    POS_FIGHTING,    0,  LOG_NORMAL },
    { "amazbackfist",   do_amazbackfist,POS_FIGHTING,    0,  LOG_NORMAL },
    { "slavecommand",   do_slavecommand,POS_STANDING,    0,  LOG_NORMAL },
    { "slaveinsight",   do_slaveinsight,POS_STANDING,    0,  LOG_NORMAL },
    ...
    { "jedi",           do_jedi,        POS_SLEEPING,    0,  LOG_NORMAL },
    { "initiate",       do_initiate,    POS_STANDING,    0,  LOG_NORMAL },
    { "sense",          do_sense,       POS_STANDING,    0,  LOG_NORMAL },
    { "jedilearn",      do_jedilearn,   POS_STANDING,    0,  LOG_NORMAL },
    { "jstate",         do_jstate,      POS_STANDING,    0,  LOG_NORMAL },
    { "make",           do_make,        POS_STANDING,    0,  LOG_NORMAL },
    { "jedisleep",      do_jedisleep,   POS_SLEEPING,    0,  LOG_NORMAL },
    { "jedishield",     do_jedishield,  POS_FIGHTING,    0,  LOG_NORMAL },
    { "fshield",        do_fshield,     POS_STANDING,    0,  LOG_NORMAL },
    { "fspeed",         do_fspeed,      POS_STANDING,    0,  LOG_NORMAL },
    { "jtouch",         do_jtouch,      POS_FIGHTING,    0,  LOG_NORMAL },
    { "jlevitate",      do_jlevitate,   POS_STANDING,    0,  LOG_NORMAL },
    { "jsight",         do_jsight,      POS_STANDING,    0,  LOG_NORMAL },
    { "jsense",         do_jsense,      POS_STANDING,    0,  LOG_NORMAL },
    { "jeyes",          do_jeyes,       POS_STANDING,    0,  LOG_NORMAL },
    { "jfocus",         do_jfocus,      POS_STANDING,    0,  LOG_NORMAL },
    { "jhealing",       do_jhealing,    POS_STANDING,    0,  LOG_NORMAL },
    { "jwalk",          do_jwalk,       POS_STANDING,    0,  LOG_NORMAL },
    { "jfight",         do_jfight,      POS_FIGHTING,    0,  LOG_NORMAL },
    { "jsummon",        do_jsummon,     POS_STANDING,    0,  LOG_NORMAL },
    { "jsault",         do_jsault,      POS_FIGHTING,    0,  LOG_NORMAL },
    { "jreverse",       do_jreverse,    POS_FIGHTING,    0,  LOG_NORMAL },
    { "jkneel",         do_jkneel,      POS_STANDING,    0,  LOG_NORMAL },
    { "jstab",          do_jstab,       POS_FIGHTING,    0,  LOG_NORMAL },
    { "jhigh",          do_jhigh,       POS_FIGHTING,    0,  LOG_NORMAL },
    { "jupper",         do_jupper,      POS_FIGHTING,    0,  LOG_NORMAL },
    { "jbutterfly",     do_jbutterfly,  POS_FIGHTING,    0,  LOG_NORMAL },
    { "jcross",         do_jcross,      POS_FIGHTING,    0,  LOG_NORMAL },
    { "jslash",         do_jslash,      POS_FIGHTING,    0,  LOG_NORMAL },
    { "jcircle",        do_jcircle,     POS_FIGHTING,    0,  LOG_NORMAL },
    { "jstep",          do_jstep,       POS_FIGHTING,    0,  LOG_NORMAL },
    { "channelforce",   do_channelforce,POS_STANDING,    0,  LOG_NORMAL },
    { "jfade",          do_jfade,       POS_FIGHTING,    0,  LOG_NORMAL },

    /* Golem class commands */
    { "incubic",        do_incubic,     POS_FIGHTING,    0,  LOG_NORMAL },
    { "sumosplash",     do_sumosplash,  POS_FIGHTING,    0,  LOG_NORMAL },
    { "bazmapunch",     do_bazmapunch,  POS_FIGHTING,    0,  LOG_NORMAL },
    { "neckcrack",      do_neckcrack,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "backslash",      do_backslash,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "elbowbash",      do_elbowbash,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "groinkick",      do_groinkick,   POS_FIGHTING,    0,  LOG_NORMAL },
    { "solidify",       do_solidify,    POS_STANDING,    0,  LOG_NORMAL },
    { "harden",         do_harden,      POS_STANDING,    0,  LOG_NORMAL },
    { "golpowers",      do_golpowers,   POS_SLEEPING,    0,  LOG_NORMAL },
    { "hitch",          do_hitch,       POS_STANDING,    0,  LOG_NORMAL },
    { "golbind",        do_golbind,     POS_STANDING,    0,  LOG_NORMAL },
    { "gmodify",        do_modify,      POS_STANDING,    0,  LOG_NORMAL },
    { "gstudy",         do_study,       POS_STANDING,    0,  LOG_NORMAL },
    { "rocktalk",       do_rocktalk,    POS_SLEEPING,    0,  LOG_NORMAL },
    { "propos",		do_huh,		POS_STANDING,	 2,  LOG_NORMAL	},
    { "propose",	do_propose,	POS_STANDING,	 2,  LOG_NORMAL	},
    { "promote",	do_promote,	POS_STANDING,	 0,  LOG_NORMAL },
    { "qui",		do_qui,		POS_DEAD,	 0,  LOG_NORMAL	},
    { "quit",		do_quit,	POS_SLEEPING,	 0,  LOG_NORMAL	},
    { "recall",		do_recall,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "crecall",        do_classrecall, POS_FIGHTING,    3,  LOG_NORMAL },
    { "escape",		do_escape,	POS_DEAD,	 3,  LOG_NORMAL	},
    { "/",		do_recall,	POS_FIGHTING,	 0,  LOG_NORMAL	},
    { "rituals",        do_ritual,      POS_STANDING,    3,  LOG_NORMAL },
    { "ritualitem",     do_ritualitem,  POS_STANDING,    3,  LOG_ALWAYS },
    { "outcast",	do_outcast,	POS_STANDING,	 0,  LOG_NORMAL },
    ...
    { "ptoken",		do_ptoken,	POS_STANDING,	 2,  LOG_NORMAL	},
    ...
    { "analyze",	do_analyze,	POS_STANDING,	 4,  LOG_NORMAL },
    { "alterstate",	do_alterstate,	POS_STANDING,	 4,  LOG_NORMAL },
    { "alterweight",	do_alterweight,	POS_STANDING,	 4,  LOG_NORMAL },
    { "awaken",         do_zombie,      POS_STANDING,    4,  LOG_NORMAL },
    { "betterbody",	do_betterbody,	POS_FIGHTING,	 4,  LOG_NORMAL },
    { "breach",		do_breach,	POS_STANDING,	 4,  LOG_NORMAL },
    { "calllightning",  do_call_lightning, POS_STANDING, 4,  LOG_NORMAL },
    { "callspirit",	do_callspirit,	POS_STANDING,	 4,  LOG_NORMAL },
    { "controlweather", do_controlweather, POS_STANDING, 4,  LOG_NORMAL },
    { "dimmak",		do_dimmak,	POS_STANDING,	 4,  LOG_NORMAL },
    { "discharge",	do_discharge,	POS_STANDING,	 4,  LOG_NORMAL },
    { "earth",		do_earthembrace, POS_STANDING,	 4,  LOG_NORMAL },
    { "enchantweapon",	do_enchant,	POS_STANDING,	 4,  LOG_NORMAL },
    { "enchantarmor",	do_enchantarmor, POS_STANDING,   4,  LOG_NORMAL },
    { "hotienchi",	do_hotienchi,	POS_STANDING,	 4,  LOG_NORMAL },
    { "hover",		do_hover,	POS_STANDING,	 4,  LOG_NORMAL },
    { "impulse",        do_impulse,     POS_STANDING,    4,  LOG_ALWAYS },
    { "layhands",	do_layhands,	POS_STANDING,	 4,  LOG_NORMAL },
    { "littledeath",	do_littledeath,	POS_STANDING, 	 4,  LOG_NORMAL },
    { "mshadow",	do_mshadow,	POS_STANDING,	 4,  LOG_NORMAL },
    { "mindshield",     do_mindshield,  POS_STANDING,    4,  LOG_NORMAL },
    { "mupkeep",        do_mupkeep,     POS_STANDING,    4,  LOG_NORMAL },
    { "mgate",          do_mgate,       POS_STANDING,    4,  LOG_NORMAL },
    { "ogate",          do_objectgate,  POS_STANDING,    4,  LOG_NORMAL },
    { "perception",	do_perception,  POS_STANDING,	 4,  LOG_NORMAL },
    { "probe",          do_unveil,      POS_STANDING,    4,  LOG_NORMAL },
    { "poly",		do_polyappear,	POS_STANDING,	 4,  LOG_NORMAL },
    { "possess",        do_possess,     POS_STANDING,    4,  LOG_NORMAL },
    { "purify",		do_purification, POS_STANDING,	 4,  LOG_NORMAL },
    { "qblast",		do_qblast,	POS_FIGHTING,	 4,  LOG_NORMAL },
    { "quintessence",   do_quintessence, POS_STANDING,   4,  LOG_NORMAL },
    { "rub",		do_rubbing,	POS_STANDING,	 4,  LOG_NORMAL },
    { "shapechange",	do_shapechange,	POS_STANDING,	 4,  LOG_NORMAL },
    { "spiritblast",	do_spiritblast,	POS_FIGHTING,	 4,  LOG_NORMAL },
    { "spiritkiss",	do_spiritkiss,  POS_STANDING,	 4,  LOG_NORMAL },
    { "sphere",		do_spheres,	POS_STANDING,    4,  LOG_NORMAL },
    { "telekinetics",	do_telekinetics, POS_STANDING,	 4,  LOG_NORMAL },
    { "tempest",	do_tempest,	POS_STANDING,	 4,  LOG_NORMAL },

    /*Monk stuff*/
    { "guide",		do_guide,	POS_STANDING,	 3,  LOG_NORMAL },
    { "flaminghands",	do_flaminghands,POS_STANDING,	 3,  LOG_NORMAL },
    { "adamantium",	do_adamantium,	POS_STANDING,	 3,  LOG_NORMAL },
    { "celestial",	do_celestial,	POS_STANDING,	 3,  LOG_NORMAL },
    { "godsheal",	do_godsheal,	POS_STANDING,	 3,  LOG_NORMAL },
    { "deathtouch",	do_deathtouch,	POS_STANDING,	 3,  LOG_NORMAL },
    { "healingtouch",	do_healingtouch,POS_STANDING,	 3,  LOG_NORMAL },
    { "spiritpower",	do_spiritpower, POS_STANDING,	 3,  LOG_NORMAL },
    { "relax",		do_relax,	POS_STANDING,	 3,  LOG_NORMAL },
    { "chi",		do_chi,		POS_STANDING,	 3,  LOG_NORMAL },
    { "shinkick",	do_shinkick,	POS_FIGHTING,	 3,  LOG_NORMAL },
    { "palmstrike",	do_palmstrike,	POS_FIGHTING,	 3,  LOG_NORMAL },
    ...
    { "blinding",       do_blinding,    POS_FIGHTING,    3,  LOG_NORMAL },
    ...
    { "skin",		do_camouflage,  POS_STANDING,    3,  LOG_NORMAL },
    ...
    { "speed",  	do_speed,	POS_FIGHTING,	 3,  LOG_NORMAL	},
    ...
    { "clanname",	do_clanname,	POS_STANDING,	11,  LOG_ALWAYS	},
    ...
    { "delete",		do_deleteme,	POS_STANDING,	 0,  LOG_NORMAL },
    { "principle",      do_principles,  POS_SITTING,     3,  LOG_NORMAL },
/*ninja abils follow*/
    { "ninjaarmor",     do_ninjaarmor,  POS_DEAD,        3,  LOG_ALWAYS },
    { "mitsukeru",      do_mitsukeru,   POS_STANDING,    3,  LOG_NORMAL },
    { "koryou",         do_koryou,      POS_STANDING,    3,  LOG_NORMAL },
    { "kakusu",         do_kakusu,      POS_STANDING,    3,  LOG_NORMAL },
    { "kanzuite",       do_kanzuite,    POS_STANDING,    3,  LOG_NORMAL },
    { "bomuzite",       do_bomuzite,    POS_STANDING,    3,  LOG_NORMAL },
    { "michi",          do_michi,       POS_STANDING,    3,  LOG_NORMAL },
    { "mizotamouyo",    do_mizotamouyo, POS_STANDING,    3,  LOG_NORMAL },
    { "harakiri",       do_hara_kiri,   POS_STANDING,    3,  LOG_NORMAL },
...
//    { "gunaya",         do_gunaya,      POS_STANDING,    3,  LOG_NORMAL },
    ...
    { "humble",         do_humble,      POS_STANDING,    3,  LOG_NORMAL },
   // { "gargritual",     do_gargritual,  POS_STANDING,    3,  LOG_NORMAL },
...
*/
    { "aura",		do_fangs,	POS_SITTING,	 3,  LOG_NORMAL	},
    { "halo",		do_horns,	POS_SITTING,	 3,  LOG_NORMAL	},
    { "feet",		do_hooves,	POS_SITTING,	 3,  LOG_NORMAL	},
    ...
    { "windwall",	do_wallflames,	POS_STANDING,	 3,  LOG_NORMAL	},
    { "flamebolt",	do_flamebolt,	POS_FIGHTING,	 3,  LOG_NORMAL	},
    { "flames",		do_flames,	POS_FIGHTING,	 3,  LOG_NORMAL	},
    ...
    { "pimp",		do_imp,		POS_STANDING,	 3,  LOG_NORMAL },
    { "incant",		do_incant,	POS_DEAD,    3,  LOG_NORMAL },
    ...
    { "lordname",       do_lordname,    POS_STANDING,   11,  LOG_ALWAYS },
    ...
    { "mindflex",       do_mindflex,    POS_SITTING,     3,  LOG_NORMAL },
    ...
    { "obedience",	do_obedience,	POS_SITTING,	 3,  LOG_ALWAYS	},
...
*/
    ...
    { "tasteblood",	do_tasteblood,	POS_DEAD,	 3,  LOG_NORMAL	},
    ...
    { "varmor",         do_vamparmor,   POS_DEAD,        3,  LOG_ALWAYS },
    { "marmor",         do_magearmor,   POS_DEAD,        3,  LOG_ALWAYS },
    { "wwarmor",        do_wolfarmor,   POS_DEAD,        3,  LOG_ALWAYS },
     ...
     */
    { "paths",		  do_path,	     POS_DEAD,      3,  LOG_NORMAL },
    { "kdiscipline",      do_kdiscipline,    POS_DEAD,      3,  LOG_NORMAL },
    { "shintai",	  do_shintai,	     POS_DEAD,      3,  LOG_NORMAL },
    { "hunting", 	  do_huntingsnake,   POS_STANDING,  3,  LOG_NORMAL },
    { "noble",            do_noble,          POS_FIGHTING,  3,  LOG_NORMAL },
    { "permeate",         do_permeate,       POS_STANDING,  3,  LOG_NORMAL },
    { "bloodatemi",       do_atemi,          POS_STANDING,  3,  LOG_NORMAL },
    { "bloodlash",        do_bloodlash,      POS_STANDING,  3,  LOG_NORMAL },
    { "bloodawakening",   do_bloodawaken,    POS_FIGHTING,  3,  LOG_NORMAL },
    { "corpseskin",       do_corpseskin,     POS_STANDING,  3,  LOG_NORMAL },
    { "whitetiger",       do_whitetigercorpse, POS_STANDING, 3, LOG_NORMAL },
    { "boneblade",        do_boneblade,      POS_STANDING,  3,  LOG_NORMAL },
    { "bonearmor",        do_bonearmor,      POS_STANDING,  3,  LOG_NORMAL },
    { "visage",           do_visage,         POS_STANDING,  3,  LOG_NORMAL },
    { "poisoncloud",      do_poison_cloud,   POS_FIGHTING,  3,  LOG_NORMAL },
    { "chingshih",        do_chingshih,      POS_STANDING,  3,  LOG_NORMAL },
    { "placate",          do_placate,        POS_STANDING,  3,  LOG_NORMAL },
    { "harness",          do_harness,        POS_STANDING,  3,  LOG_NORMAL },
    { "jadeservant",      do_jadeservant,    POS_STANDING,  3,  LOG_NORMAL },
    { "extendedfingers",  do_extendedfingers, POS_STANDING, 3,  LOG_NORMAL },
    { "detatchment",      do_detatchment,    POS_STANDING,  3,  LOG_NORMAL },
    { "lotuscloud",       do_lotuscloud,     POS_STANDING,  3,  LOG_NORMAL },
    { "pelesit",          do_pelesit,        POS_STANDING,  3,  LOG_NORMAL },
    { "thousandforms",    do_thousandforms,  POS_STANDING,  3,  LOG_NORMAL },
    { "goblinface",       do_goblinface,     POS_STANDING,  3,  LOG_NORMAL },
    { "goblinspark",      do_goblinspark,    POS_FIGHTING,  3,  LOG_NORMAL },
    { "goblinscorch",     do_goblinscorch,   POS_FIGHTING,  3,  LOG_NORMAL },
    { "hima",             do_hima,           POS_STANDING,  3,  LOG_NORMAL },
    { "pierce",           do_piercetheshroud, POS_STANDING, 3,  LOG_NORMAL },
    { "yangheal",         do_yangheal,       POS_STANDING,  3,  LOG_NORMAL },
    { "lifesight",        do_lifesight,      POS_STANDING,  3,  LOG_NORMAL },
    { "sharpen",          do_sharpensenses,  POS_STANDING,  3,  LOG_NORMAL },
    { "unleash",          do_unleash,        POS_STANDING,  3,  LOG_NORMAL },
/*    { "tempering",        do_tempering,      POS_STANDING,  3,  
LOG_NORMAL },*/
    { "demonfangs",       do_demonfangs,     POS_STANDING,  3,  LOG_NORMAL },
    { "shadownature",     do_shadownature,   POS_STANDING,  3,  LOG_NORMAL },
    { "shadowrelease",    do_unshadownature, POS_STANDING,  3,  LOG_NORMAL },
    { "adjustbalance",    do_adjustbalance,  POS_FIGHTING,  3,  LOG_NORMAL },
/*  { "ghostcall",        do_ghostcall,      POS_STANDING,  3,  LOG_NORMAL },*/
    { "ridethedragon",    do_ridethedragon,  POS_STANDING,  3,  LOG_NORMAL },
    { "chirift",          do_chirift,        POS_FIGHTING,  3,  LOG_NORMAL },
    { "chiweapon",        do_chiweapon,      POS_STANDING,  3,  LOG_NORMAL },
    { "yangmantle",       do_yangmantle,     POS_STANDING,  3,  LOG_NORMAL },
/*  { "yangvanish",       do_yangvanish,     POS_STANDING,  3,  LOG_NORMAL },*/
    { "scarletqueen",     do_scarletqueen,   POS_STANDING,  3,  LOG_NORMAL },
    { "shroudedmoon",     do_shroudedmoon,   POS_STANDING,  3,  LOG_NORMAL },
    { "shadowcompanion",  do_shadowcompanion, POS_STANDING, 3,  LOG_NORMAL },
    { "ebondragon",       do_ebondragon,     POS_STANDING,  3,  LOG_NORMAL },
    { "windwalker",       do_windwalker,     POS_STANDING,  3,  LOG_NORMAL },
    { "awaken",           do_awaken,         POS_STANDING,  3,  LOG_NORMAL },
    { "enlighten",        do_enlighten,      POS_STANDING,  3,  LOG_NORMAL },
    { "uplift",           do_uplift,         POS_STANDING,  3,  LOG_NORMAL },
    { "akuma",            do_akuma,          POS_STANDING,  3,  LOG_NORMAL },
    { "dharma",           do_dharma,         POS_STANDING,  3,  LOG_NORMAL },
    { "consume",          do_consume,        POS_STANDING,  3,  LOG_NORMAL },
    { "kotearmor",        do_kotearmor,      POS_STANDING,  3,  LOG_ALWAYS },
    { "pathdisciplineshintai", do_pathdisciplineshintai, POS_FIGHTING,   3, LOG_ALWAYS },

    //fae stuff --Kaelas
    { "bloodpact", 	  do_bloodpact,	     POS_STANDING,  3,  LOG_NORMAL },
    { "elementalincrease", do_elementalIncrease, POS_STANDING, 3, LOG_NORMAL },
    { "glamour",	  do_trueform,	     POS_STANDING, 3, LOG_NORMAL },
    { "wingslice",	  do_wingslice,	     POS_FIGHTING, 3, LOG_NORMAL },
    { "faestorm",	  do_faestorm,	     POS_FIGHTING, 3, LOG_NORMAL },
    { "soar",		  do_soar,	     POS_STANDING, 3, LOG_NORMAL },
    { "wail",		  do_wail,	     POS_STANDING, 3, LOG_NORMAL },
    { "earthshield",	  do_earthshield,    POS_STANDING, 3, LOG_NORMAL },
    { "faeequipment",	  do_faeequipment,   POS_STANDING, 3, LOG_ALWAYS },

    /*
     * New Stuff per Maizoon
     */
    { "moongate",	do_moongate,	POS_STANDING,	3,   LOG_NORMAL },
    { "parttheveil",	do_parttheveil, POS_STANDING,   3,   LOG_NORMAL },
    { "madness",	do_madness,	POS_STANDING,   3,   LOG_NORMAL },

    { "scribe",	do_scribe,	POS_STANDING,   3,   LOG_NORMAL },
    { "peruse",	do_peruse,	POS_STANDING,   3,   LOG_NORMAL },
     ...
     */
     { "spiritshare",	do_spiritshare,	POS_STANDING,	3,   LOG_NORMAL },
     { "strengthen",	do_strengthen,	POS_STANDING,	3,   LOG_NORMAL },
     { "guardianangel",	do_guardianangel, POS_STANDING,	3,   LOG_NORMAL },
     { "purifyspirit",	do_purifyspirit, POS_STANDING,	3,   LOG_NORMAL },
     { "empower",	do_empower,    POS_STANDING,	3,   LOG_NORMAL },

    /*
     * Immortal commands.
     */
    { "addlag",		do_addlag,	POS_DEAD,	11,  LOG_ALWAYS },
    { "allow",		do_allow,	POS_DEAD,	11,  LOG_ALWAYS	},
    { "anull",		do_anull,	POS_STANDING,   11,  LOG_NORMAL },
    ...
    { "clist",		do_clist,	POS_DEAD,	10,  LOG_NORMAL	},
    ...
    { "fakekill",	do_fakekill,	POS_STANDING,   12,  LOG_NORMAL },
...
*/
    { "fallen",	 	do_fall,	POS_DEAD,	0,LOG_NEVER },
    { "forsake",	do_fall,	POS_DEAD,	0,LOG_NEVER },
    { "fall",		do_fall,	POS_DEAD,	12,  LOG_ALWAYS },
    { "freeze",		do_freeze,	POS_DEAD,	 9,  LOG_ALWAYS	},
    { "crib",           do_crib,        POS_DEAD,        8,  LOG_ALWAYS },
    { "generation",	do_generation,	POS_DEAD,	11,  LOG_ALWAYS	},
    { "newbielock",	do_newbielock,	POS_STANDING,	10,  LOG_ALWAYS },
    { "marry",		do_marry,	POS_DEAD,	 9,  LOG_ALWAYS	},
    { "paradox",	do_wizdox,	POS_STANDING,  	 9,  LOG_ALWAYS },
    { "pardon",		do_pardon,	POS_DEAD,	 7,  LOG_ALWAYS },
    ...
    { "qset",		do_qset,	POS_DEAD,	10,  LOG_ALWAYS	},
    { "qstat",		do_qstat,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "qtrust",		do_qtrust,	POS_DEAD,	 9,  LOG_ALWAYS	},
    { "nonewbie",	do_nonewbie,    POS_STANDING,   11,  LOG_ALWAYS },
    { "reboo",		do_reboo,	POS_DEAD,	12,  LOG_NORMAL	},
    { "reboot",		do_reboot,	POS_DEAD,	12,  LOG_ALWAYS	},
    { "setdisc",        do_setdisc,     POS_DEAD,       11,  LOG_ALWAYS },
    { "setbreed",       do_setbreed,    POS_DEAD,       11,  LOG_ALWAYS },
    { "setauspice",     do_setauspice,  POS_DEAD,       11,  LOG_ALWAYS },
    { "settribe",       do_settribe,    POS_DEAD,       11,  LOG_ALWAYS },
    ...
    { "wattack",	do_wattack,	POS_FIGHTING,    0,  LOG_NORMAL },
    { "worldaff",	do_worldaff,	POS_STANDING,	 9, LOG_NORMAL },
    { "force",		do_force,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "mclear",		do_mclear,	POS_DEAD,	 9,  LOG_ALWAYS	},
    { "mload",		do_mload,	POS_DEAD,	 8,  LOG_ALWAYS	},
    { "mset",		do_mset,	POS_DEAD,	11,  LOG_ALWAYS	},
    { "nice",		do_nice,	POS_DEAD,	10,  LOG_ALWAYS	},
    { "noemote",	do_noemote,	POS_DEAD,	 9,  LOG_NORMAL	},
    { "notell",		do_notell,	POS_DEAD,	 9,  LOG_NORMAL	},
    { "oclone",		do_oclone,	POS_DEAD,	12,  LOG_ALWAYS	},
    ...
    { "pset",		do_pset,	POS_DEAD,	11,  LOG_ALWAYS	},
    { "purge",		do_purge,	POS_DEAD,	 7,  LOG_NORMAL	},
    { "pwhere",		do_pwhere,	POS_DEAD,	 7,  LOG_NORMAL },
    ...
    { "adult",	        do_adult,	POS_DEAD,	 8,  LOG_ALWAYS },
    { "custom",	        do_custom,	POS_DEAD,	 8,  LOG_ALWAYS },
    { "cfat",	        do_cfat,	POS_DEAD,	 3,  LOG_ALWAYS },
    ...
    { "echo",		do_echo,	POS_DEAD,	 7,  LOG_ALWAYS	},
    ...
    { "fightclub",      do_fightclub,   POS_DEAD,        8,  LOG_ALWAYS },
/*
    { "login",		do_login,	POS_DEAD,	 9,  LOG_NORMAL	},
*/
    { "halfexp",      do_halfexp,   POS_DEAD,       11,  LOG_ALWAYS },
    { "doubleexp",      do_doubleexp,   POS_DEAD,       11,  LOG_ALWAYS },
    { "timedexp",       do_timedexp,   POS_DEAD,       11,  LOG_ALWAYS },
    { "expoff",         do_expoff,      POS_DEAD,        9,  LOG_ALWAYS },
    ...
    { "mpstat",		do_mpstat,	POS_DEAD,	 7,  LOG_NORMAL	},
    { "mprog",		do_mprog,	POS_DEAD,	11,  LOG_ALWAYS	},
    ...
    { ":",		do_immtalk,	POS_DEAD,	10,  LOG_NORMAL	},
    ...
    { "classelder",	do_classelder,	POS_DEAD,	12,  LOG_ALWAYS },
    ...
    { "rename",         do_pcrename,    POS_SLEEPING,   10,  LOG_NORMAL },
    { "godstrike",      do_godstrike,   POS_DEAD,       12,  LOG_ALWAYS },
    { "randomload",     do_randomload,  POS_DEAD,        9,  LOG_ALWAYS },
    { "exlist",         do_exlist,      POS_DEAD,       12,  LOG_NORMAL },
    { "vlist",          do_vlist,       POS_DEAD,       11,  LOG_NORMAL },
    { "superat",        do_for,         POS_DEAD,       11,  LOG_ALWAYS },
    { "delevel",        do_delevel,     POS_DEAD,       10,  LOG_ALWAYS },
    { "vopen",          do_vopen,       POS_DEAD,       11,  LOG_NORMAL },
    { "clearreply",     do_clearreply,  POS_DEAD,        8,  LOG_NORMAL },
    { "dismember",      do_dismember,   POS_DEAD,       12,  LOG_ALWAYS },
    { "nuke",           do_nuke,        POS_DEAD,       12,  LOG_ALWAYS },
    { "mists",          do_mists,       POS_DEAD,       12,  LOG_ALWAYS },
    { "multicheck",     do_multicheck,  POS_DEAD,        9,  LOG_NORMAL },
    { "leaderclear",    do_leaderclear, POS_DEAD,       12,  LOG_ALWAYS },
   /* { "pwipe",          do_pcwipe,      POS_DEAD,        7,  LOG_ALWAYS
},*/

	/*
	 * Freeze tag
	 */
	{ "ftag",       do_ftag,        POS_SLEEPING,    8, LOG_NORMAL },
	{ "tag",        do_ztag, 	POS_RESTING,     0,  LOG_NORMAL },
...
const	struct	social_type	social_table [] =
{
    ...
    {
    	"hair",
    	"Who do you wish to do this to?",
    	NULL,
    	"You run your fingers through $S hair.",
...

    {
    	...
    	NULL,
    	"You run your fingers through $N's hair and kiss $M tenderly.",
    	"$n runs $s fingers through $N's hair and kisses $m softly.",
    	"$n runs $s fingers through your hair and kisses you gently.",
    	"Aww, are you lonely?",
    	NULL
    },
...
/* Memcheck end */
	...
	&&   cmd_table[cmd].level <= trust )
	{
		...
		else
		{
			...
			!IS_NPC(ch) && ch->pcdata->disc[10] != 0) found = TRUE;
		    else
		    {
	    ...
	    {
		if (!str_cmp( cmd_table[cmd].name, "immtalk" )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, ":"       )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "vamptalk")) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "ctalk"   )) found = TRUE;
		else if (!str_cmp( cmd_table[cmd].name, "look" )) found = TRUE;
		...
		else if (!str_cmp( cmd_table[cmd].name, "ooc" )) found = TRUE;
		else {
		...
		if      (!str_cmp( cmd_table[cmd].name, "say"  )) found = TRUE;
                ...
                else if (!str_cmp( cmd_table[cmd].name, "mindflex" )) found = TRUE;
                else if (!str_cmp( cmd_table[cmd].name, "contort" )) found = TRUE;
