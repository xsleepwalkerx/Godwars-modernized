 ...
 */
    ...
    {
	"cause critical",	2,
	spell_cause_critical,	TAR_DEATH,      	POS_FIGHTING,
	NULL,			SLOT(63),	20,	12,
    ...
    {
	"cause light",		1,
	spell_cause_light,	TAR_DEATH,      	POS_FIGHTING,
	NULL,			SLOT(62),	15,	12,
	"spell",		"!Cause Light!"
    },
    ...
    {
	"cause serious",	2,
	spell_cause_serious,	TAR_DEATH,      	POS_FIGHTING,
	NULL,			SLOT(64),	17,	12,
	"spell",		"!Cause Serious!"
    },
    ...
    {
	"chill touch",		3,
	spell_chill_touch,	TAR_DEATH,      	POS_FIGHTING,
	NULL,			SLOT( 8),	15,	12,
 ...
 */
...

    {
        ...
        spell_null,             TAR_IGNORE,             POS_STANDING,
        NULL,                   SLOT(96),        100,   12,
        "",                     "The black spell on you fades away."
    },

    {
        "Winged Attack",        99,
        spell_null,             TAR_IGNORE,             POS_STANDING,
        &gsn_wattack,           SLOT( 0),        0,     24,
        "Winged Attack",        "!Tongue!"
    },
    /*
     * KOE Fury/backfist- Ktulu
     */
    {
         "fury",                99,
         spell_null,            TAR_IGNORE,             POS_STANDING,
    ...
    {
         "spinning backfist",   99,
         spell_null,            TAR_IGNORE,             POS_STANDING,
         &gsn_backfist,         SLOT( 0),         0,    24,
         "spinning backfist",   "!Backfist!"
    },
    {
	 "circling strike",     99,
         spell_null,            TAR_IGNORE,             POS_STANDING,
