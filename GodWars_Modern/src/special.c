...
DECLARE_SPEC_FUN(	spec_clan_ventrue	);
DECLARE_SPEC_FUN(	spec_clan_ventrue2	);
DECLARE_SPEC_FUN(	spec_clan_ventrue3	);
DECLARE_SPEC_FUN(   	spec_clan_hellfire  	);
DECLARE_SPEC_FUN(	spec_clan_hotei		);
DECLARE_SPEC_FUN(	spec_clan_tremere	);
DECLARE_SPEC_FUN(	spec_clan_chemosh3	);
DECLARE_SPEC_FUN(   	spec_clan_assimite  	);
DECLARE_SPEC_FUN(   	spec_clan_assimite2  	);
DECLARE_SPEC_FUN(   	spec_clan_bishamon  	);
DECLARE_SPEC_FUN(   	spec_clan_ravnos  	);
DECLARE_SPEC_FUN(   	spec_clan_bishamon3  	);
DECLARE_SPEC_FUN(   	spec_clan_kotaro  	);
DECLARE_SPEC_FUN(   	spec_clan_kotaro2  	);
DECLARE_SPEC_FUN(   	spec_clan_kotaro3  	);
DECLARE_SPEC_FUN(   	spec_clan_yellow  	);
DECLARE_SPEC_FUN(       spec_clan_yellow2       );
DECLARE_SPEC_FUN(	spec_clan_malkavian	);
DECLARE_SPEC_FUN(       spec_clan_jurojin       );
DECLARE_SPEC_FUN(       spec_clan_earth         );
DECLARE_SPEC_FUN(       spec_clan_ww            );
DECLARE_SPEC_FUN(       spec_clan_water         );
DECLARE_SPEC_FUN(       spec_clan_shatain       );
DECLARE_SPEC_FUN(       spec_clan_shatain2      );
DECLARE_SPEC_FUN(       spec_clan_brujah        );
DECLARE_SPEC_FUN(       spec_clan_brujah2       );
DECLARE_SPEC_FUN(       spec_clan_brujah3       );
DECLARE_SPEC_FUN(	spec_zombie_lord	);
DECLARE_SPEC_FUN(	spec_dog		);
DECLARE_SPEC_FUN(	spec_crib		);
DECLARE_SPEC_FUN(       spec_clan_mudevi        );
DECLARE_SPEC_FUN(       spec_clan_mudevi2       );
DECLARE_SPEC_FUN(       spec_clan_mudevi3       );
DECLARE_SPEC_FUN(       spec_class_vampire      );
DECLARE_SPEC_FUN(       spec_class_mage         );
DECLARE_SPEC_FUN(       spec_class_ninja        );
DECLARE_SPEC_FUN(       spec_class_werewolf     );
DECLARE_SPEC_FUN(       spec_class_demon        );
DECLARE_SPEC_FUN(       spec_class_angel        );
...
SPEC_FUN *spec_lookup( const char *name )
{
    ...
    if ( !str_cmp( name, "spec_clan_ventrue"      ) ) return spec_clan_ventrue;
    if ( !str_cmp( name, "spec_clan_ventrue2"     ) ) return spec_clan_ventrue2;
    if ( !str_cmp( name, "spec_clan_ventrue3"     ) ) return spec_clan_ventrue3;
    if ( !str_cmp( name, "spec_clan_hellfire"     ) ) return spec_clan_hellfire;
    if ( !str_cmp( name, "spec_clan_assimite"     ) ) return spec_clan_assimite;
    if ( !str_cmp( name, "spec_clan_assimite2"    ) ) return spec_clan_assimite2;
    if ( !str_cmp( name, "spec_clan_bishamon"     ) ) return spec_clan_bishamon;
    if ( !str_cmp( name, "spec_clan_ravnos"       ) ) return spec_clan_ravnos;
    if ( !str_cmp( name, "spec_clan_bishamon3"    ) ) return spec_clan_bishamon3;
    if ( !str_cmp( name, "spec_clan_hotei"        ) ) return spec_clan_hotei;
    if ( !str_cmp( name, "spec_clan_tremere"      ) ) return spec_clan_tremere;
    if ( !str_cmp( name, "spec_clan_chemosh3"     ) ) return spec_clan_chemosh3;
    if ( !str_cmp( name, "spec_clan_kotaro"       ) ) return spec_clan_kotaro;
    if ( !str_cmp( name, "spec_clan_kotaro2"      ) ) return spec_clan_kotaro2;
    if ( !str_cmp( name, "spec_clan_kotaro3"      ) ) return spec_clan_kotaro3;
    if ( !str_cmp( name, "spec_clan_yellow"       ) ) return spec_clan_yellow;  
    if ( !str_cmp( name, "spec_clan_yellow2"      ) ) return spec_clan_yellow2;
    if ( !str_cmp( name, "spec_clan_malkavian"    ) ) return spec_clan_malkavian;
    if ( !str_cmp( name, "spec_clan_jurojin"      ) ) return spec_clan_jurojin;
    if ( !str_cmp( name, "spec_clan_earth"        ) ) return spec_clan_earth;
    if ( !str_cmp( name, "spec_clan_ww"           ) ) return spec_clan_ww;
    if ( !str_cmp( name, "spec_clan_water"        ) ) return spec_clan_water;
    if ( !str_cmp( name, "spec_clan_shatain"      ) ) return spec_clan_shatain;
    if ( !str_cmp( name, "spec_clan_shatain2"     ) ) return spec_clan_shatain2;
    if ( !str_cmp( name, "spec_clan_brujah"       ) ) return spec_clan_brujah;
    if ( !str_cmp( name, "spec_clan_brujah2"      ) ) return spec_clan_brujah2;
    if ( !str_cmp( name, "spec_clan_brujah3"      ) ) return spec_clan_brujah3;
    if ( !str_cmp( name, "spec_zombie_lord"       ) ) return spec_zombie_lord;
    if ( !str_cmp( name, "spec_dog"		  ) ) return spec_dog;
    if ( !str_cmp( name, "spec_crib"		  ) ) return spec_crib;
    if ( !str_cmp( name, "spec_clan_mudevi"       ) ) return spec_clan_mudevi;
    if ( !str_cmp( name, "spec_clan_mudevi2"      ) ) return spec_clan_mudevi2;
    if ( !str_cmp( name, "spec_clan_mudevi3"      ) ) return spec_clan_mudevi3;
    if ( !str_cmp( name, "spec_class_vampire"     ) ) return spec_class_vampire;
    if ( !str_cmp( name, "spec_class_mage"        ) ) return spec_class_mage;
    if ( !str_cmp( name, "spec_class_ninja"       ) ) return spec_class_ninja;
    if ( !str_cmp( name, "spec_class_werewolf"    ) ) return spec_class_werewolf;
    if ( !str_cmp( name, "spec_class_demon"       ) ) return spec_class_demon;
    if ( !str_cmp( name, "spec_class_angel"       ) ) return spec_class_angel;
    return 0;
}
...
bool spec_cast_adept( CHAR_DATA *ch )
{
    ...
    {
    case 0:
	act( "$n utters the word 'loricatus'.", ch, NULL, NULL, TO_ROOM );
	spell_armor( skill_lookup( "armor" ), ch->level, ch, victim );
	return TRUE;

    case 1:
	act( "$n utters the word 'beatus'.", ch, NULL, NULL, TO_ROOM );
	spell_bless( skill_lookup( "bless" ), ch->level, ch, victim );
	return TRUE;

    case 2:
	act( "$n utters the words 'rememdium caecus'.", ch, NULL, NULL, TO_ROOM );
	spell_cure_blindness( skill_lookup( "cure blindness" ),
	    ch->level, ch, victim );
	return TRUE;

    case 3:
	act( "$n utters the words 'rememdium minimus'.", ch, NULL, NULL, TO_ROOM );
	spell_cure_light( skill_lookup( "cure light" ),
	    ch->level, ch, victim );
	return TRUE;

    case 4:
	act( "$n utters the words 'rememdium venenum'.", ch, NULL, NULL, TO_ROOM );
	spell_cure_poison( skill_lookup( "cure poison" ),
	    ch->level, ch, victim );
	return TRUE;

    case 5:
	act( "$n utters the word 'novo'.", ch, NULL, NULL, TO_ROOM );
...
bool spec_guard2( CHAR_DATA *ch )
{
	...
	if (rand == 1)
	{
	    sprintf( buf, "Get out of my way %s!",
	        victim->name);
	    do_say( ch, buf );
	}
	else if (rand == 2)
	{
	    act("You mutter something under your breath about $N.",ch,NULL,victim,TO_CHAR);
	    act("$n mutters something about you.",ch,NULL,victim,TO_VICT);
	    act("$n mutters under their breath about $N.",ch,NULL,victim,TO_NOTVICT);
	}
	else if (rand == 3)
	{
	    act("You snarl at $N.",ch,NULL,victim,TO_CHAR);
	    act("$n snarls at you.",ch,NULL,victim,TO_VICT);
	    act("$n snarls at $N.",ch,NULL,victim,TO_NOTVICT);
	    sprintf( buf, "Great, I get to see %s's ugly face again...",
	        victim->name);
	    do_say( ch, buf );
	}
/* Insolent gay dog comment */
	else if (rand == 4)
	{
	    act("You give $N an annoyed look.",ch,NULL,victim,TO_CHAR);
	    act("$n gives you a annoyed look.",ch,NULL,victim,TO_VICT);
	    act("$n gives $N a annoyed look.",ch,NULL,victim,TO_NOTVICT);
	    sprintf( buf, "%s, arcátlan nagy kujon...",
	        victim->name);
	    do_say( ch, buf );
	}
	else
    ...
    if ( ech != NULL )
    {
/* sissy girly person comment */
	if (!IS_NPC(ech) && IS_EXTRA(ech, EXTRA_AWE))
	{
	    sprintf( buf, "You dare to attack %s! You shall suffer and die!",
	        ech->name);
	    do_say( ch, buf );
		act( "$n screams 'Die, puhány asszony valaki!'", ch, NULL, NULL, TO_ROOM );
	    do_rescue( ch, ech->name );
	    return TRUE;
	}
	act( "$n shouts 'This looks like fun, ATTACK!!'", ch, NULL, NULL, TO_ROOM );
	multi_hit( ch, ech, gsn_backstab );
	return TRUE;
    }
...
bool spec_gremlin_born( CHAR_DATA *ch )
{
   ...
   for ( object = ch->in_room->contents; object; object = object_next )
   {
	  ...
	  */
	 if (ch->max_move > 75 && number_percent() > 97)
	 {
	   ...
	   !(( IS_OBJ_STAT( object, ITEM_ANTI_EVIL   ) && IS_EVIL   ( ch ) ) ||
		...
		if (!obj2)
		{
			...
			default:
			    ...
			    break;
                        case ITEM_PILL:
                            strcpy(buf, "Hrm,  always wanted a pill!");
                            do_say(ch,buf);
...
bool spec_kavir_guardian(CHAR_DATA *ch)
{
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->name != NULL && !strcmp(victim->name,"Becker") )
           || (victim->clan != NULL && !strcmp(victim->clan,"Ventrue") )
      ...
      act("$n shouts at you \"Your soul is mine!\"",ch,ch->long_descr,victim,TO_VICT);

      spell_curse( 24 , 100 , ch , victim );
	  
      spell_web( 131 , 100 , ch , victim );
	...
	ch->position == POS_STANDING)
	 ...
	 sprintf( buf,"%s has been beheaded for their crimes against the Ventrue clan.",victim->name);
	 do_info(ch, buf);
	 ...
	 behead( victim, ch );
         ...
         sprintf( buf,"%s's head is at the Temple Altar, someone sac it!\n\r", victim->name);
         do_shout ( ch , buf);

         continue;
      }
/*      sprintf( buf,"%s Is in the Ventrue Headquarters! Attack!\n\r", victim->name);
      do_shout( ch, buf);
*/
      multi_hit( ch, victim, gsn_backstab);
      return TRUE;
...
bool spec_clan_ventrue (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || IS_ITEMAFF(victim, ITEMA_DBPASS))
	{
        ...
        if (ch->in_room!=victim->in_room)
        {
           act("$n disappears in a swirl of mist!",ch,NULL,NULL,TO_ROOM);
           act("You disappear in a swirl of mist!",ch,NULL,NULL,TO_CHAR);

           char_from_room( ch );
           char_to_room(ch, victim->in_room);

           act("$n appears in a swirl of mist!",ch,NULL,NULL,TO_ROOM);
           act("You appear in a swirl of mist!",ch,NULL,NULL,TO_CHAR);
        }
     
        act("$n shouts at you \"DIE!\"",ch,ch->long_descr,victim,TO_VICT);
	...
	spell_gas_breath( 70 , 100 , ch , victim );
...
bool spec_clan_ventrue2(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
      ...
      spell_dispel_magic( 31 , 100 , ch , victim );
	  
      spell_curse( 24 , 100 , ch , victim );

      spell_lightning_breath( 71 , 200 , ch , victim );
...
bool spec_clan_ventrue3(CHAR_DATA *ch)
{
    DESCRIPTOR_DATA       *d;
    CHAR_DATA             *victim;
	...
	if (!IS_PLAYING(d)
	   ...
	   || IS_ITEMAFF(victim, ITEMA_DBPASS))
        ...
        if (ch->in_room != victim->in_room)
        {
	    act("$n leaps into the shadows!",ch,NULL,NULL,TO_ROOM);
	    act("You leap into the shadows!",ch,NULL,NULL,TO_CHAR);

	    char_from_room( ch );
	    char_to_room(ch, victim->in_room);

	    act("$n leaps from the shadows!",ch,NULL,NULL,TO_ROOM);
	    act("You leap from the shadows!",ch,NULL,NULL,TO_CHAR);
	}
     
	if (is_safe(ch,victim)) continue;

	act("$n roars at you \"Excessum!\"",ch,ch->long_descr,victim,TO_VICT);
        act("You let out a battlecry as you defend the clan headquarters!",ch,NULL,victim,TO_CHAR);

        spell_curse( 24 , 100 , ch , victim ); /* No Recall */

	spell_poison( 53 , 200 , ch , victim );
	...
	ch->position == POS_STANDING)
    {
	 ...
	 char_to_room(victim, get_room_index(ROOM_VNUM_ALTAR));
        ...
        multi_hit( ch, victim, gsn_tongue);
...
bool spec_clan_hotei (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Hotei") ))
	{
            continue;
        }
	  ...
	  ch->position == POS_STANDING)
        ...
        sprintf( buf,"%s Is in the Hotei Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_assimite2(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Tzimisce") ))
           {
             continue;
           }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Tzimisce clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
...
bool spec_clan_chemosh3 (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Order of Chemosh") ))
	{
            continue;
        }
        ...
        if (ch->in_room!=victim->in_room)
        {
           ...
           act("You disappear in a flash of light!",ch,NULL,NULL,TO_CHAR);

           char_from_room( ch );
           char_to_room(ch, victim->in_room);

           act("$n appears in a flash of light!",ch,NULL,NULL,TO_ROOM);
           act("You appear in a flash of light!",ch,NULL,NULL,TO_CHAR);
        }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Chemosh clan.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_clan_assimite (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
           ...
           || (victim->clan != NULL && !strcmp(victim->clan,"Tzimisce") ))
	{
	 ...
	 behead( victim, ch );
        ...
        sprintf( buf,"%s Is in the Tzimisce Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_bishamon (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Bishamon") ))
	{
            continue;
        }
	  ...
	  ch->position == POS_STANDING)
        ...
        sprintf( buf,"%s Is in the Bishamon Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_ravnos (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Ravnos") ))
	{
            continue;
        }
        ...
        if (ch->in_room!=victim->in_room)
        {
           act("$n disappears in a swirl of shadows!",ch,NULL,NULL,TO_ROOM);
           act("You disappear in a swirl of shadows!",ch,NULL,NULL,TO_CHAR);

           char_from_room( ch );
           char_to_room(ch, victim->in_room);

           act("$n appears in a swirl of shadows!",ch,NULL,NULL,TO_ROOM);
           act("You appear in a swirl of shadows!",ch,NULL,NULL,TO_CHAR);
        }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Ravnos clan.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
	 ...
	 behead( victim, ch );
		...
		sprintf( buf,"%s Is in the Ravnos Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_bishamon3 (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
/*   char                  buf[MAX_STRING_LENGTH]; */
...
bool spec_clan_hellfire (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Hellfire") ))
	{
            continue;
        }
	  ...
	  ch->position == POS_STANDING)
        ...
        sprintf( buf,"%s Is in the Hellfire Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_kotaro (CHAR_DATA *ch)
{
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Kotaro") ))
	{
            continue;
        }
...
bool spec_clan_kotaro2 (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
           ...
           || (victim->clan != NULL && !strcmp(victim->clan,"Kotaro") ))
	{
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Kotaro clan.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_clan_kotaro3 (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
/*   char                  buf[MAX_STRING_LENGTH]; */
...
bool spec_clan_yellow (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
           ...
           || IS_MAGE(victim))
	{
	  ...
	  ch->position == POS_STANDING)
        ...
        sprintf( buf,"%s Is in the Lightning Mage Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_yellow2(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
        ...
        if (ch->in_room != victim->in_room)
        {
           act("$n disappears in a swirl of smoke!",victim,NULL,NULL,TO_ROOM);
           ...
           act("You appear into a swirl of smoke!",victim,NULL,NULL,TO_CHAR);
        }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Lightning clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
...
bool spec_clan_malkavian (CHAR_DATA *ch)
{
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
       if (!IS_PLAYING(d)
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"LaSombra") ))
        {
            continue;
        }
        ...
        sprintf( buf,"%s Is in the LaSombra Headquarters! Attack!\n\r", victim->name);
        do_shout( ch , buf);
...
bool spec_clan_jurojin (CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Jurojin") ))
	{
            continue;
        }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Jurojin clan.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
	 ...
	 behead( victim, ch );
        ...
        sprintf( buf,"%s Is in the Jurojin Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_earth(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
        ...
        if (ch->in_room != victim->in_room)
        {
           act("$n disappears in a haze of green!",victim,NULL,NULL,TO_ROOM);
           act("You disappear into a haze of green!",victim,NULL,NULL,TO_CHAR);

           char_from_room( victim );
           char_to_room(victim, ch->in_room);

           act("$n appears in a haze of green!",victim,NULL,NULL,TO_ROOM);
           act("You appear into a haze of green!",victim,NULL,NULL,TO_CHAR);
        }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Earth Mage clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
	   ...
	   behead( victim, ch );
        ...
        sprintf( buf,"%s Is In The Earth Mage Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_ww(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	  ...
	  ch->position == POS_STANDING)
        ...
        sprintf( buf,"%s Is In the Werewolf Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_water(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
        ...
        if (ch->in_room != victim->in_room)
        {
           ...
           act("You appear into a haze of blue!",victim,NULL,NULL,TO_CHAR);
        }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Water clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
	   ...
	   behead( victim, ch );
        ...
        sprintf( buf,"%s Is In The Water Mage Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_shatain(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
	   || (victim->name != NULL && !strcmp(victim->name,"Kause") )
           || (victim->lord != NULL && !strcmp(victim->lord,"Kause") ))
           {
             continue;
           }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against Kause's clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
	   ...
	   behead( victim, ch );
        ...
        sprintf( buf,"%s Is In Kause's Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_shatain2(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
...
bool spec_clan_brujah2(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
//   char                  buf[MAX_STRING_LENGTH];
...
bool spec_clan_brujah3(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Brujah clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
...
/*
        sprintf( buf,"%s Is In The Order of Zen Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
*/      
        multi_hit( ch, victim, gsn_punch); 
        return TRUE;
...
bool spec_clan_mudevi(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->clan != NULL && !strcmp(victim->clan,"Mudevi") ))
           {
             continue;
           }
	  ...
	  ch->position == POS_STANDING)
        {
           sprintf( buf,"%s has been beheaded for his crimes against the Mudevi clan.",victim->name);
	   do_info(ch, buf);
           if (victim->level == 3) victim->level=victim->level-1;
           victim->pdeath=victim->pdeath+1;
	   ...
	   behead( victim, ch );
        ...
        sprintf( buf,"%s Is In The Mudevi Headquarters! Attack!\n\r", victim->name); 
        do_shout( ch , buf);
...
bool spec_clan_mudevi2(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
//   char                  buf[MAX_STRING_LENGTH];
...
bool spec_clan_mudevi3(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
...
bool spec_crib( CHAR_DATA *ch )
{
	...
	{
	case 0:
	    act("#p$n smiles at you playfully.",ch,NULL,victim,TO_VICT);
	    act("#p$n smiles playfully at $N.",ch,NULL,victim,TO_NOTVICT);
	    return TRUE;

	case 1:
	    act("#p$n begins to rub you all over.",ch,NULL,victim,TO_VICT);
	    act("#p$n begins to rub $N's body.",ch,NULL,victim,TO_NOTVICT);
	    return TRUE;

	case 2:	
	    act("#pYou feel something poke you on your butt.",ch,NULL,victim,TO_VICT);
	    return TRUE;
	...
	case 3:
	    ...
	    if (cstat >= 1)
	    {
             act("#p$n removes your clothing making you vulnerable to his every whim.",ch,NULL,victim,TO_VICT);
             act("#p$n removes $N's clothing.",ch,NULL,victim,TO_NOTVICT);
             sprintf( buf, "MmmmMmm, You......won't be needing this.");
             do_say( ch, buf );
	    }
 
	    if(cstat < 1)
	     {
	     act("#p$n starts from your shoulders and caresses his hands down your body.",ch,NULL,victim,TO_VICT);
	     act("#p$n starts from the shoulders and caresses his hands down $N's body.",ch,NULL,victim,TO_NOTVICT);
	     do_emote(ch,"#p moans loudly as drool falls from his lips.");
             break;
	     } 
	    return TRUE;

	case 4:	
	    act("#pYou see a purple blur as $n slaps you in the face with something extending from his lower torso.",ch,NULL,victim,TO_VICT);
	    act("#p$n slaps $N in the face with something unrecognizable extending from his lower torso.",ch,NULL,victim,TO_NOTVICT);
	    return TRUE;

	case 5:	
	    sprintf( buf, "Gosh!!  This is fun!!");
	    do_say(ch,buf);
	    return TRUE;
	case 6:
	    sprintf( buf, "OO!  CHILDREN!!  Lets have some fun!");
	    do_say(ch,buf);
	}
    }
...
bool spec_class_vampire(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
      ...
      if (ch->in_room!=victim->in_room)
      {
         act("A pair of bloody hands reach up from the ground.",victim,NULL,NULL,TO_ROOM);
         act("A pair of bloody hands reach up from the ground.",victim,NULL,NULL,TO_CHAR);
         act("The hands grab $n by the ankles and pull $m into the ground!",victim,NULL,NULL,TO_ROOM);
         act("The hands grab you by the ankles and pull you into the ground!",victim,NULL,NULL,TO_CHAR);
         char_from_room( victim );
         char_to_room(victim, ch->in_room);
      ...
      act("$n shouts at you \"Time to die!\"",ch,ch->long_descr,victim,TO_VICT);
	...
	ch->position == POS_STANDING)
      {
         ...
         act("You tear $N's head from $S shoulders!",ch,NULL,victim,TO_CHAR);
	 send_to_char("Your head is torn from your shoulders!\n\r",victim);
	 sprintf( buf,"%s has been beheaded for invading the Vampire HQ.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_class_mage(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
      ...
      if (ch->in_room!=victim->in_room)
      {
         act("A bright light forms around $n, and they vanish!",victim,NULL,NULL,TO_ROOM);
         act("A bright light forms around you, the room starts to vanish!",victim,NULL,NULL,TO_CHAR);
         char_from_room( victim );
         char_to_room(victim, ch->in_room);
      }
	...
	ch->position == POS_STANDING)
      {
         ...
         act("You tear $N's head from $S shoulders!",ch,NULL,victim,TO_CHAR);
	 send_to_char("Your head is torn from your shoulders!\n\r",victim);
	 sprintf( buf,"%s has been beheaded for invading the Mage HQ.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_class_ninja(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
      ...
      if (ch->in_room!=victim->in_room)
      {
         act("The darkness enfolds $n, and they vanish!",victim,NULL,NULL,TO_ROOM);
         act("Darkness surrounds you, the room vanish!",victim,NULL,NULL,TO_CHAR);
         char_from_room( victim );
         char_to_room(victim, ch->in_room);
      }
	...
	ch->position == POS_STANDING)
      {
         ...
         act("You tear $N's head from $S shoulders!",ch,NULL,victim,TO_CHAR);
	 send_to_char("Your head is torn from your shoulders!\n\r",victim);
	 sprintf( buf,"%s has been beheaded for invading the Ninja HQ.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_class_werewolf(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
      ...
      if (ch->in_room!=victim->in_room)
      {
         act("Vines shoot out of the ground.",victim,NULL,NULL,TO_ROOM);
         act("Vines shoot from the ground.",victim,NULL,NULL,TO_CHAR);
         act("The vines grab $n by the ankles and pull $m into the ground!",victim,NULL,NULL,TO_ROOM);
         act("The vines grab you by the ankles and pull you into the ground!",victim,NULL,NULL,TO_CHAR);
         char_from_room( victim );
         char_to_room(victim, ch->in_room);
      }
	...
	ch->position == POS_STANDING)
      {
         ...
         act("You tear $N's head from $S shoulders!",ch,NULL,victim,TO_CHAR);
	 send_to_char("Your head is torn from your shoulders!\n\r",victim);
	 sprintf( buf,"%s has been beheaded for invading the Werewolf HQ.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_class_demon(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->name != NULL && !strcmp(victim->name, "Lorena"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Lorena"))
           || (victim->name != NULL && !strcmp(victim->name, "Thoth"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Thoth"))
           || (victim->name != NULL && !strcmp(victim->name, "Desdemona"))
	   || (victim->lord != NULL && !strcmp(victim->lord, "Desdemona"))
           || (victim->name != NULL && !strcmp(victim->name, "Krel"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Krel"))
           || (victim->name != NULL && !strcmp(victim->name, "Vanquish"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Vanquish"))
           || (victim->name != NULL && !strcmp(victim->name, "Dilaudid"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Dilaudid"))
	   || (victim->name != NULL && !strcmp(victim->name, "Kause"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Kause")) 
	   || (victim->name != NULL && !strcmp(victim->name, "Abbadon"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Abbadon"))) 
           {
             continue;
           }
      ...
      if (ch->in_room!=victim->in_room)
      {
         act("Flames erupt from the ground and engulf $n!",victim,NULL,NULL,TO_ROOM);
         act("Flames erupt from the ground and engulf you!",victim,NULL,NULL,TO_CHAR);
         char_from_room( victim );
         char_to_room(victim, ch->in_room);
      }
	...
	ch->position == POS_STANDING)
      {
         ...
         act("You tear $N's head from $S shoulders!",ch,NULL,victim,TO_CHAR);
	 send_to_char("Your head is torn from your shoulders!\n\r",victim);
	 sprintf( buf,"%s has been beheaded for invading the Demon HQ.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
...
bool spec_class_angel(CHAR_DATA *ch)
{
   DESCRIPTOR_DATA       *d;
   CHAR_DATA             *victim;
   char                  buf[MAX_STRING_LENGTH];
   ...
   for (d = descriptor_list; d != NULL; d = d->next)
   {
	   ...
	   || victim->in_room == NULL
           ...
           || victim->in_room->area != ch->in_room->area
           || victim->in_room == ch->in_room
           || (victim->name != NULL && !strcmp(victim->name, "Selena"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Selena"))
           || (victim->name != NULL && !strcmp(victim->name, "Ophelia"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Ophelia"))
           || (victim->name != NULL && !strcmp(victim->name, "Uriel"))
	   || (victim->lord != NULL && !strcmp(victim->lord, "Uriel"))
	   || (victim->name != NULL && !strcmp(victim->name, "Solanar"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Solanar"))
	   || (victim->name != NULL && !strcmp(victim->name, "Odysseus"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Odysseus"))
	   || (victim->name != NULL && !strcmp(victim->name, "Ishamael"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Ishamael"))
           || (victim->name != NULL && !strcmp(victim->lord, "Duunken"))
           || (victim->lord != NULL && !strcmp(victim->lord, "Duunken")))
           {
             continue;
           }
      ...
      if (ch->in_room != victim->in_room)
      {
         act("A thick mist rises around $n, and they vanish!",victim,NULL,NULL,TO_ROOM);
         act("A thick mist rises around you, the room starts to fade away!",victim,NULL,NULL,TO_CHAR);
         char_from_room( victim );
         char_to_room(victim, ch->in_room);
      }
	...
	ch->position == POS_STANDING)
      {
         ...
         act("You tear $N's head from $S shoulders!",ch,NULL,victim,TO_CHAR);
	 send_to_char("Your head is torn from your shoulders!\n\r",victim);
	 sprintf( buf,"%s has been beheaded for invading the Angel HQ.",victim->name);
	 do_info(ch, buf);
         if (victim->level == 3) victim->level=victim->level-1;
         victim->pdeath=victim->pdeath+1;
