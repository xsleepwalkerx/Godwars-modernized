...
struct bard_song_text bard_songs[MAX_TEXT][37] = {
    {   /* love song, healing */
        {"Fairies Love Song"},
    ...
    {   /* song of violence, hate/hurt song */
        {"Sounds of Violence"},
    ...
    {   /* battle song */
        {"Bold Sir Robin"}, {"Bravely bold Sir Robin"},
        {"Brought forth from Camelot"}, {"He was not afraid to die"},
        {"Bold, Brave Sir Robin"}, {"He was not at all afraid"},
    ...
    {   /* defense song */
        {"Ansteorran Fight Song"}, {"Hail, hail the Black and the Gold"},
        {"We're gonna win because we're so bold"},
        {"Kick their faces in the mud"}, {"Stomp out their teeth and draw their blood"},
        {"We're gonna beat them, just wait and see"},
        {"And we will win a great vic-to-ry"},
        {"And we'll teach them all to never"},
        {"Take on the Black and Gold"}, {"end"}
    },
    {   /* calm song */
        {"The Bard's Lament"},
    ...
    {   /* charming song */
        {"The Unicorn"}, {"The unicorn is a wondrous beast"},
        {"Bold, handsone brave and stron"},
        {"And upon its proud gentle head"},
        {"It has a single spiral horn"}, {"Oh mighty beast, O unicorn"},
        {"Fill me with your light"}, {"And grant that I may hear your muse"},
        {"And keep you in my isght"},
        {"Oh bold and lovely unicorn"}, {"Guide us with your horn"},
        {"and teach us of the magick realms"},
        {"into which you have gone"}, {"Magick, magick, unicron"},
        {"Please keep me in your grace"},
        {"and yould your like I ever see"}, {"I'll heartily embrace"}, {"end"}
    },
    {   /* fear song */
        {"Dragon Element Call"},
    ...
    {   /* animal song */
        {"Animal Elemental Call"}, {"Powers and magick of the East"},
        {"Raven, flying on wings of Air"},
        {"My circle calls you to descend"}, {"Alone or in a pair"},
        {"By the power of Air"}, {"So mote it be!"},
        {"Powers and magick of the South"}, {"Dragon, breathing streams of Fire"},
        ...
        {"My circle calls you to descend"}, {"With light, love and laughter"},
        {"By the power of Water"},
        {"So mote it be!"}, {"Powers and magick of the North"},
        {"Wolf, howling to mother Earth"},
        {"My circle calls you to descend"},
        {"From your northern mountains of Earth"}, {"By the power of Earth"},
        {"So mote it be!"}, {"end"}
    },
    {   /* sleep song */
        {"Sleep Prayer"}, {"Now I lay me down to rest"},
        {"I pray tomorrow I'll do my best"},
        {"If I should err in any way"},
