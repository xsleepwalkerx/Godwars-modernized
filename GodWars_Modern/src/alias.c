...
/*
 * alias.c — Ported from Distorted Illusions / ROT 1.4
 * Adapted for GodWars Modernized: removed the ROT prefix command
 * feature (ch->prefix not in our char_data).
 */
...
/*
 * substitute_alias — called from comm.c instead of interpret() so that
 * player-defined aliases are expanded before the command is dispatched.
 */
void substitute_alias( DESCRIPTOR_DATA *d, char *argument )
{
    ...
    /* Skip alias processing for NPC, empty alias list, or alias/una commands */
    if ( IS_NPC(ch)
