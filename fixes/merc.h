...
/*
 * Merge repair block (EM + Genesis): restore utility macros/constants that
 * several merged source files expect from the parent codebases.
 */
#ifndef LOWER
...
#endif
#ifndef STR
/* Merge repair: legacy OLC code expects STR(dat, field) to guard NULL strings. */
#define STR(dat, field)         ((((dat)->field) != NULL && ((dat)->field)[0] != '\0') ? (dat)->field : "")
#endif
#ifndef IS_JUDGE
#define IS_JUDGE(ch)            (get_trust(ch) >= LEVEL_JUDGE)
#endif
#ifndef IS_QUESTMAKER
...
#endif
#ifndef IS_NEWBIE
/* Merge repair note: use the classic low-level newbie gate until the
 * merged code's age/time-based newbie protection is fully reconciled. */
...
#endif
#ifndef CAN_PK
/* Merge repair note: prefer the simpler EM-style trust gate for now.
 * The Genesis FLAG_PK system can be restored later once its flag tables
 * are fully merged. */
#define CAN_PK(ch)              (get_trust(ch) >= 3 && get_trust(ch) <= 6)
#endif

/* Modern libc compatibility: several old Merc/GodWars files call crypt()
 * without a visible prototype under modern C modes. */
...
#define MORE_CHAMPION       65536 /* Merge repair: reconcile duplicate definition with EM/Genesis */
/* Merge repair constants restored from EM/Genesis. */
#ifndef AREA_ADDED
#define AREA_ADDED             2
#endif
#ifndef ARM_PURPLE
#define ARM_PURPLE             1       /* Merge repair: KaVir quest armor tier */
#endif
#ifndef ARM_RED
#define ARM_RED                2
#endif
...
#define MSPI                   3
#endif
#ifndef OBJ_VNUM_ASHES
#define OBJ_VNUM_ASHES         30042
#endif
#ifndef SITEM_HIGHLANDER
#define SITEM_HIGHLANDER       524288
#endif
#ifndef QUEST_SPELLPROOF
...
#endif
#ifndef EXTRA_CLEARED_EQ
#define EXTRA_CLEARED_EQ       4194304  /* Merge repair: equipment reset tracking */
#endif
#ifndef DISABLED_FILE
#define DISABLED_FILE          "disabled.txt"
#endif
#ifndef EXE_FILE
#define EXE_FILE               "../src/merc"    /* Merge repair: copyover launcher path */
#endif
#ifndef COPYOVER_FILE
#define COPYOVER_FILE          "copyover.data"  /* Merge repair: hot reboot state file */
#endif
...
#define ROOM_DEATHTRAP      65536   /* Merge repair: legacy deathtrap alias */
...
#define EX_CLOSED           2
#define EX_LOCKED           4
#define EX_BASHPROOF        8       /* Merge repair: OLC expects EM/Genesis bashproof bit */
...
/* Area flags for OLC */
#define AREA_NONE           0       /* Merge repair: OLC expects an explicit no-flags value */
 ...
 */
#define OBJ_VNUM_NOTEPAPER      8       /* Merge repair: Kavir quest editor paper */
#define OBJ_VNUM_EMPTY_EGG      30003   /* Merge repair: egg hatch object template */
...
#define MCOR    0   /* Merge repair: correspondence */
#define MLIF    1   /* Merge repair: life */
#define MPRI    2   /* Merge repair: prime */
#define MENT    4   /* SPHERE_MIND */
#define MFOR    6   /* Merge repair: forces */
#define MMAT    7   /* Merge repair: matter */
 ...
 */
#define TOTEM_BOAR      1
#define TOTEM_BEAR      TOTEM_BOAR  /* Merge repair: preserve EM naming expected by update.c */
...
void    clear_stats     ( CD *ch ); /* Merge repair */
void    crack_head      ( CD *ch, OD *obj, char *argument ); /* Merge repair */
void    critical_hit    ( CD *ch, CD *victim, int dt, int dam ); /* Merge repair */
void    disarm          ( CD *ch, CD *victim ); /* Merge repair */
void    improve_wpn     ( CD *ch, int dtype, bool right_hand ); /* Merge repair */
void    make_part       ( CD *ch, char *argument ); /* Merge repair */
void    one_hit         ( CD *ch, CD *victim, int dt, int handtype ); /* Merge repair: match merged fight.c */
void    raw_kill        ( CD *victim, CD *ch ); /* Merge repair */
void    behead          ( CHAR_DATA *victim, CHAR_DATA *ch ); /* Merge repair: used by special.c */
void    paradox         ( CHAR_DATA *ch ); /* Merge repair: forward declaration for update.c */
void    take_item       ( CD *ch, OD *obj ); /* Merge repair */
...
void    kavitem         ( const char *format, CD *ch,
                          const void *arg1, const void *arg2, int type );
void    mud_logf        ( char *fmt, ... ); /* Merge repair: avoid conflict with libm logf() */
...
DECLARE_DO_FUN( do_fatality     ); /* Merge repair */
DECLARE_DO_FUN( do_forceauto    ); /* Merge repair */
DECLARE_DO_FUN( do_info         ); /* Merge repair */
DECLARE_DO_FUN( do_mortalvamp   ); /* Merge repair */
DECLARE_DO_FUN( do_moutcast     ); /* Merge repair */
DECLARE_DO_FUN( do_noutcast     ); /* Merge repair */
DECLARE_DO_FUN( do_tradition    ); /* Merge repair */
DECLARE_DO_FUN( do_unwerewolf   ); /* Merge repair */
DECLARE_DO_FUN( do_watching     ); /* Merge repair */
DECLARE_DO_FUN( do_werewolf     ); /* Merge repair */
...
#ifndef DEM_MAGIC
#define DEM_MAGIC 4 /* Merge repair: object spellcasting flag from EM */
#endif
...
#ifndef OBJ_VNUM_BLOOD_SPRING
#define OBJ_VNUM_BLOOD_SPRING 23
#endif

#ifndef QUEST_ENCHANTED
#define QUEST_ENCHANTED 32768
#endif

#ifndef POW_ANIMALISM
...
#define COT_NO_KILL_SECT       8
#define COT_NO_KILL_COTERIE    16
#endif
...
/* Merge repair: zombie AI states expected by special.c. */
...
void    show_spell      ( CHAR_DATA *ch, int dtype ); /* Merge repair: kav_info forward declaration */
DECLARE_DO_FUN( do_spydirection ); /* Merge repair: kav_info helper command */
...
/* Merge repair: qstats[] indices expected by Kavir quest improvement code. */
#define QS_TOTAL        0
#define QS_HIT          1
#define QS_DAM          2
#define QS_AC           3
